...
<template>
<div tabindex="1" class="group bg-transparent flex relative transition-all duration-500 rounded-md pl-4 lg:hover:shadow-[inset_0_1px_0_0_rgba(148,163,184,0.1)] lg:hover:drop-shadow-lg lg:hover:bg-slate-800/50 hover:!opacity-100 group-hover/card:opacity-50 group-focus/card:opacity-50">
    <p class="text-xs pt-7 font-medium w-[105px] uppercase">{{ date }}</p>
    <div :class="{ 'border-l-2': last, 'p-0': true, 'pl-5': true, 'flex-1': true, 'pr-5': true, 'relative': true }">
        <!--Actual content-->
        <div class="flex flex-col items-start rounded-md mb-2 p-6 ease-in-out duration-300 transition-all">
