...
<template>
    <article tabindex="1" class="mt-32 mb-20">
        ...
        <p class="text-lg font-light text-white/70">
            Lately I have been eager to learn more about <strong>C#</strong> and <strong>.NET</strong> as a whole, as I though it would be a great addition to my <strong>TypeScript</strong>/Node.js skillset.
        </p>
    </article>
